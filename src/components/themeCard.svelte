<script>
    let { titulo, numero, enlace_youtube, 
enlace_privado, artista, episodios } = $props();
</script>

<article>
    <div class="main-content">
        <button class="play-button" aria-label="Play theme">
    ...
    {#if enlace_youtube}
        <a href={enlace_youtube} target="_blank" class="youtube-link" aria-label="Watch on YouTube">
