...
## next commit
1 Se ha desarrollado la interfaz de usuario (frontend) para
la sección de perfil de usuario.
2 Se añadió el archivo `TODO.md` para documentar las tareas
y funcionalidades futuras planificadas.
3 - he refactorizó el endpoint `/api/filtro` para implementar
la paginación, limitando la carga a un máximo de 12  
 documentos por petición.
6 Se actualizó la página principal (`/+page.svelte`) para
integrar la funcionalidad de "cargar más" y asegurar que  
 los filtros funcionen correctamente con el nuevo sistema de
paginación.
